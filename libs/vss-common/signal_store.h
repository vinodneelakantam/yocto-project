...
//
// Lives in its own package (//libs/vss-common) so every independently-built
// Bazel service under apps/ (sdv-vehicle-service, sdv-diagnostics-service,
// ...) can depend on and reuse the same implementation. See
// docs/bazel-build-system.md for the build-graph-partitioning rationale.

#ifndef SDV_LIBS_VSS_COMMON_SIGNAL_STORE_H_
#define SDV_LIBS_VSS_COMMON_SIGNAL_STORE_H_
...
#endif  // SDV_LIBS_VSS_COMMON_SIGNAL_STORE_H_
